...
describe('Example', () => {
  it('should load the app', async () => {
    ...
    await reloadApp({ urlBlacklist: [url + '/onchange'] });
    console.log('App launched');
    await expect(
      element(by.label('Open up App.js to start working on your app!'))
    ).toBeVisible();
  });

  it.skip('should load the app with the url', async () => {
  ...
  it.skip('should open the app URL', async () => {
